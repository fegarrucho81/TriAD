...
function resetGame() {
    ...
    // Adiciona a linha abaixo para esconder a mensagem de compartilhamento e o overlay
    document.getElementById('shareMessage').style.display = 'none';
    document.getElementById('shareOverlay').style.display = 'none';
    ...
    // Atualiza o array de grupos com novas palavras
    correctGroups = newCorrectGroups; // Mudança para novos grupos

    // Atualiza o tabuleiro de jogo com as novas palavras
    updateBoard();
}
...
function updateBoard() {
    ...
    // Gera as novas palavras e as coloca no tabuleiro
